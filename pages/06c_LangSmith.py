"""Phase 10c — LangSmith (Coming Soon)"""
import streamlit as st

st.set_page_config(page_title="Phase 10c — LangSmith", page_icon="🔬", layout="wide")
...
padding:32px;text-align:center;margin-bottom:28px;">
  ...
  <div style="font-size:1.5rem;font-weight:700;color:#1C2833;margin-bottom:6px;">Phase 10c — LangSmith</div>
...
st.markdown("""
- LangSmith = LangChain's observability platform (connects to Phase 7a)
- Tracing: every LangGraph node logged automatically
- Dataset management: build evaluation sets from production traces
- Regression testing: run eval sets on every code change
- Playground: test prompts and chains without writing code
""")
